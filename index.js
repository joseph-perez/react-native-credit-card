                    ...
                    <View style={[styles.front, {width: this.props.width, height: this.props.height}]}>
                        ...
                        <View style={styles.lower}>
                            ...
                            <View style={styles.info}>
                                <View style={styles.number}><Text style={[styles.textNumber, { color: this.props.textNumberColor }]}>{this.getValue("number")}</Text></View>
                                <View style={styles.rowWrap}>
                                    <View style={styles.name}><Text style={[styles.textName, { color: this.props.textNameColor }]}>{this.getValue("name")}</Text></View>
                                    ...
                                    <View
                                        ...
                                        <Text style={[styles.textExpiry, { color: this.props.textExpiryColor }]}>{this.getValue("expiry")}</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
